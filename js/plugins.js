...
// nickm: this is modified to use <a> instead of <button> for multiline support,
// and to inject svg as the tick icon in the dropdown
...
(function ($) {
  ...
  var svgTickIcon = '<svg class="icon icon-tick">' +
  ...
  Selectpicker.prototype = {
    ...
    init: function () {
      ...
      this.$menu = this.$newElement.children('.select-dropdown');
      this.$menuInner = this.$menu.children('.inner');
      this.$searchbox = this.$menu.find('input');

      if (this.options.dropdownAlignRight)
        this.$menu.addClass('select-dropdown-right');
    ...
    createDropdown: function () {
      ...
      '</div>'
          : '';
      var drop =
          '<div class="bootstrap-select' + multiple + inputGroup + '">' +
          '<a href="#" type="button" class="dropdown-toggle" data-toggle="dropdown"' + autofocus + '>' +
    ...
    liHeight: function (refresh) {
      ...
      menu.className = 'select-dropdown open';
      menuInner.className = 'select-dropdown inner';
    ...
    setWidth: function () {
      if (this.options.width === 'auto') {
        ...
        var $selectClone = this.$menu.parent().clone().appendTo('body'),
            ...
            ulWidth = $selectClone.children('.select-dropdown').outerWidth(),
    ...
    clickListener: function () {
      ...
      /*this.$newElement.on('touchstart.dropdown', '.select-dropdown', function (e) {
        e.stopPropagation();
      });*/
    ...
    keydown: function (e) {
      ...
      isActive = that.$menu.closest('.bootstrap-select').hasClass('open');
